 ...
 * Proyecto de final de año: 2022
 * Integrantes: Celina Gillo Mayer, Joaquín Pablo Tissera
 */
#include <stdio.h>
#include <stdlib.h>
...
int main(int argc, char **argv)
{
    ...
    printf("Por favor, inserte el nombre del archivo que usará para el programa (sin el .dat): \n");
    scanf("%[^\n]", nombreArchivo);
